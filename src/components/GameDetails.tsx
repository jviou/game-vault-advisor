...
import { Star, Calendar, Gamepad2, Trash2 } from "lucide-react";
...
export function GameDetails({ game, isOpen, onClose, onDelete }: GameDetailsProps) {
  if (!game) return null;
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {onDelete && (
              <Button
                ...
                className="gap-2"
                onClick={() => {
                  if (confirm(`Supprimer définitivement "${game.title}" ?`)) {
                    onDelete(game);
                    onClose();
                  }
                }}
